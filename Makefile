PROJECT_NAME := nsxt Package

SHELL            := /bin/bash
PACK             := nsxt
ORG              := SCC-Hyperscale-fr
PROJECT          := github.com/${ORG}/pulumi-${PACK}
NODE_MODULE_NAME := @SCC-Hyperscale-fr/${PACK}
TF_NAME          := ${PACK}
...
prepare::
	...
	if [[ "${OS}" != "Darwin" ]]; then \
		sed -i 's,github.com/pulumi/pulumi-nsxt,${REPOSITORY},g' provider/go.mod; \
