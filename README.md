...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `nsxt` with the `NAME` of your provider.
...
- binary: pulumi-resource-nsxt
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-nsxt/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-nsxt/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-nsxt_darwin_amd64_v1
│   └── pulumi-resource-nsxt
├── pulumi-nsxt_darwin_arm64
│   └── pulumi-resource-nsxt
├── pulumi-nsxt_linux_amd64_v1
│   └── pulumi-resource-nsxt
├── pulumi-nsxt_linux_arm64
│   └── pulumi-resource-nsxt
├── pulumi-nsxt_windows_amd64_v1
│   └── pulumi-resource-nsxt.exe
└── pulumi-nsxt_windows_arm64
    └── pulumi-resource-nsxt.exe
```
